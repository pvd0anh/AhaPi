[[VIDEO]] https://www.youtube.com/watch?v=M_yAZHUkY1I
...
For a fraction, the reciprocal is simply the fraction turned upside down:

| Number | Reciprocal | Check |
|---|---|---|
| $5$ | $\frac{1}{5}$ | $5 \times \frac{1}{5}=1$ |
| $\frac{2}{3}$ | $\frac{3}{2}$ | $\frac{2}{3}\times\frac{3}{2}=1$ |
| $0.25=\frac{1}{4}$ | $4$ | $0.25 \times 4=1$ |

## Zero Has No Reciprocal

There is no number you can multiply by $0$ to get $1$, because $0 \times$ anything is $0$. This is the same reason division by zero is undefined.

## Why Reciprocals Matter

Dividing by a number is exactly the same as multiplying by its reciprocal.
